...
multipass exec $node_main -- bash -c "sudo echo '$node_worker2_ip $node_worker2' >> $hosts_pathway"
echo ""
...
multipass exec $node_worker1 -- bash -c "sudo echo '$node_worker2_ip $node_worker2' >> $hosts_pathway"
echo ""
...
multipass exec $node_worker2 -- bash -c "sudo chmod 666 $hosts_pathway"
multipass exec $node_worker2 -- bash -c "sudo echo '$node_main_ip $node_main' >> $hosts_pathway"
multipass exec $node_worker2 -- bash -c "sudo echo '$node_worker1_ip $node_worker1' >> $hosts_pathway"
multipass exec $node_worker2 -- bash -c "sudo echo '$node_worker2_ip $node_worker2' >> $hosts_pathway"
echo ""
echo "Check contents of $hosts_pathway on $node_worker2:"
echo ""
multipass exec $node_worker2 -- bash -c "cat $hosts_pathway"
echo $HR 

echo "Done writing to $hosts_pathway on main, worker1, worker2"
